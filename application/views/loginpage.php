        ...
        <div class="login-box card">
            <div class="card-body">
                <form class="form-horizontal form-material" id="loginform" method="POST" action="/auth/login">
                    <a href="javascript:void(0)" class="text-center db"><img src="../assets/images/logo.jpg" style="height: 100px;" alt="Home" /></a>
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            <input class="form-control" type="password" name="upass" required="" placeholder="Password">
                        </div>
                    </div>
                    <!--div class="form-group">
                        <div class="col-md-12">
                ...
                <!--form class="form-horizontal" id="recoverform" action="/search">
                    <div class="form-group ">
                        <div class="col-xs-12">
